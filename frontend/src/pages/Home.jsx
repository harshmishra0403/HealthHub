          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet in ipsa possimus,
                  rem quasi consequatur ullam, praesentium fuga ducimus dolorem
                  iste molestias quas neque adipisci assumenda autem enim, voluptas aperiam vero.
                  Numquam eius, asperiores iusto aut error eum veritatis minima unde
                  vitae vero nostrum reiciendis quam. In ipsam qui nulla!</p>
              ...
              <div className='mt-[30px] lg:mt-[70px] flex flex-col 
                ...
                <div>
                  ...
                  <p className='text__para'>Patient Satisfactin</p>
                </div>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  <img src={avatarIcon} alt="Avatar" className="w-[20px] h-[20px] lg:w-[32px] lg:h-[32px] rounded-full" />
                  <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor">
                    Wayne Collins
                  </h4>
                </div>
                <div className="rounded-full bg-white text-xs lg:text-base text-center py-1 px-2 lg:py-[6px] lg:px-[10px] mt-2 lg:mt-[18px]">
